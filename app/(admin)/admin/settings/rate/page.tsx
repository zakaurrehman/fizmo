        ...
        {loading ? (
          ...
          <div className="space-y-6">
            {categories.map((category) => (
              <div key={category}>
                <h2 className="text-fizmo-purple-400 text-sm font-semibold uppercase tracking-wider mb-3">
                  {category}
                </h2>
                <div className="space-y-2">
                  {settings[category].map((setting: any) => (
                    ...
                    >
                      <div>
                        <p className="text-white font-medium text-sm">{setting.label || setting.key}</p>
                        {setting.description && (
