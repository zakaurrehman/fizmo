...
export default function DepositReportPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-white mb-2">Deposit Report</h1>
        <p className="text-gray-400">Full deposit report for all clients</p>
      </div>
      <div className="glassmorphic rounded-xl p-6">
        <div className="overflow-x-auto">
          {loading ? (
            <div className="text-center text-gray-400 py-8">Loading deposit report...</div>
          ) : deposits.length === 0 ? (
              ...
              <tbody>
                {deposits.map((deposit: any) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-gray-400 text-sm">{deposit.currency}</td>
