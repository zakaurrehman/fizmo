...
export default function InternalTransferReportPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-white mb-2">Internal Transfer Report</h1>
        <p className="text-gray-400">Full report of all internal transfer transactions</p>
      </div>
      <div className="glassmorphic rounded-xl p-6">
        <div className="overflow-x-auto">
          {loading ? (
            <div className="text-center text-gray-400 py-8">Loading transfer report...</div>
